...
extension Category {
    ...
    static let bilsAndUtilities = Category(id: 2, name: "Bill & Utilities", icon: .file_invoice_dollar)
    ...
    static let mobilePhone = Category(id: 201, name: "Mobile Phone", icon: .phone_alt, mainCategoryId: 2)
